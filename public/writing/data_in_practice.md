...
<!-- .slide: id="transfer-learning" class="zoomout" data-audio-src="../audio/data/05.ogg" data-background-image="../images/GAN-Sarin-Japanese_landscape_1.jpg" data-background-opacity="0.7" -->
## Transfer learning
Notes:
...
<!-- .slide: id="synthetic-data" data-audio-src="../audio/data/06.ogg" data-background-video="../video/sailvos_synthetic_data_example.mp4" data-background-video-loop -->
## Synthetic Data
Notes:
...
<!-- .slide: id="cleaning" data-audio-src="../audio/data/10.ogg" data-background-image="../images/bad_data.png" data-background-size="contain" data-background-opacity="0.5" -->
## Cleaning 
...
<!-- .slide: id="balancing" data-audio-src="../audio/data/11-seg1.ogg" data-background-image="../images/dogs_cats_platypuses.webp" -->
...
<!-- .slide: id="feature-scaling" data-audio-src="../audio/data/12-seg1.ogg" -->
## Feature scaling
...
<!-- .slide: id="standardization" data-audio-src="../audio/data/12-seg3.ogg" data-background-color="#133a61" -->
### Standardization
...
<!-- .slide: id="time-series-cleaning" data-audio-src="../audio/data/16.ogg" data-background-image="../images/bad_data.png" data-background-size="contain" data-background-opacity="0.5" -->
## Cleaning
...
<!-- .slide: id="openrefine" data-audio-src="../audio/data/18.ogg" data-background-color="white" -->
...
<!-- .slide: id="existing-time-series" class="panleft" data-audio-src="../audio/data/19.ogg" data-background-image="../images/HYDE-global-data.jpg" data-background-opacity="0.3" -->
## Existing datasets
...
<!-- .slide: id="file-formats" data-audio-src="../audio/data/21.ogg" -->
## File formats
...
<!-- .slide: id="scraping" data-audio-src="../audio/data/23.ogg" data-background-image="../images/flickr_creative_commons.webp" data-background-size="contain" -->
## Scraping
...
<!-- .slide: id="preparing-images" data-audio-src="../audio/data/25.ogg" data-background-color="black" -->
## Preparing images
...
<!-- .slide: id="augmentation" data-audio-src="../audio/data/27.ogg" data-background-image="../images/biased_towards_textures.png" data-background-size="contain" data-background-opacity="0.7" -->
## Augmentation
...
<!-- .slide: id="existing-text-datasets" data-audio-src="../audio/data/30.ogg" data-background-image="../images/OpenAI-GPT.png" data-background-size="contain" data-background-color="white" -->
...
<!-- .slide: id="diversity-bias" class="panup" data-audio-src="../audio/data/33-seg1.ogg" data-background-image="../images/explainable_AI_WEIRD.webp" -->
## Diversity and Bias
...
<!-- .slide: id="disco" class="pandown" data-audio-src="../audio/data/43.ogg" data-background-image="../images/DisCo.jpg" -->
...
<!-- .slide: id="care-work" class="panup" data-audio-src="../audio/data/44-seg4.ogg" data-background-image="../images/DisCo-carework-at-the-core.jpg" data-background-opacity="0.8" -->
...
---
<!-- .slide: id="thank-you" data-audio-src="../audio/data/47.ogg" data-background-image="../images/Five_Directions_dark.webp" data-background-opacity="0.9" data-audio-advance="800" -->
# Thank you
